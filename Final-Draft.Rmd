...
Also as seen in Model2, we see that our Covid-related variable, positive does not show any effect on how many people look up the term. But political differences such as state color show us that red states tend to have the lowest interest while purple and blue states tend to have the highest interest. This is in par with the statistics that show that democrats tend to have a higher political engagement. Finally, after Trump mentioned "China Virus" the interest of the term saw a significant increase 1.1 per Day closer to when Trump held his press conference.
