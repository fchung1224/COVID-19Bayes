...
a<-Finaldata %>% 
  ...
  geom_point()+ geom_line() + labs(x = " Date", y = "China Virus Interest", title = " China Virus Interest by Day and State Color") +theme_minimal()
