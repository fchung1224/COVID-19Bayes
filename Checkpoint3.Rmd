...
weekbefore <- data.frame(states_cases_data) %>% filter(date <= as.Date("2020-03-17"))
...
weekafter <- data.frame(states_cases_data) %>% filter(date >= as.Date("2020-03-17"))
...
plot3<-statebins(state_data = weekbefore, state_col = "state",
                     ...
                     brewer_pal="Spectral", font_size = 2,breaks =7,
